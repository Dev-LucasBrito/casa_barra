                      ...
                      children: [
                        InkWell(
                          ...
                          child: AppCards.ranking(
                              ...
                              position: 2,
                              votes:
                                  controller.participantes[1].votes.toString()),
                        ),
                        InkWell(
                          onTap: () {
                          ...
                          child: AppCards.ranking(
                              ...
                              position: 1,
                              votes:
                                  controller.participantes[0].votes.toString()),
                        ),
                        InkWell(
                          onTap: () {
                          ...
                          child: AppCards.ranking(
                              ...
                              position: 3,
                              votes:
                                  controller.participantes[2].votes.toString()),
                        ),
                      ],
                    ),
                  ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding:
                            const EdgeInsets.only(top: 21, right: 12, left: 12),
                      ...
                      AppText.textSecundary(
                          text: 'Selecione alguém para votar'),
                      AppText.textPrimary(
                          text: 'VOCÊ TEM ${controller.votesUser} VOTOS'),
